...
a = [m.floor(rand.random()*2**p) for i in range(0, int(2**p*.8))]
b = [m.floor(rand.random()*2**p) for i in range(0, int(2**p*.8))]
c = [m.floor(rand.random()*2**p) for i in range(0, int(2**p*.2))]
d = [m.floor(rand.random()*2**p) for i in range(0, int(2**p*.2))]
